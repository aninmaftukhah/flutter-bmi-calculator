import 'package:app_bmi/constants.dart';
import 'package:app_bmi/reuseable_card.dart';
                  ...
                  Expanded(
                      child: ReusableCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(FontAwesomeIcons.mars, size: 88,),
                            SizedBox(
                              height: 15,
                            ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            RoundIconButton(icon: Icon(FontAwesomeIcons.minus, color: Colors.white),
                                onTap: (){
                              setState(() {
                                weight--;
                              });
                            ...
                            RoundIconButton(icon: Icon(FontAwesomeIcons.plus, color: Colors.white),
                            onTap: (){
                            setState((){
                              weight++;
                            });
